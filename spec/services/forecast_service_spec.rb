...
RSpec.describe ForecastService do
  describe 'external endpoint' do
    it 'can retrieve current forecast data for a given location', :vcr do
      lat = 39.7392
      lon = -104.9903
    ...
    it 'can retrieve hourly forecast data for a given location', :vcr do
      lat = 39.7392
      lon = -104.9903
      json = ForecastService.get_weather(lat, lon)
    ...
    it 'can retrieve daily forecast data for a given location', :vcr do
      lat = 39.7392
      lon = -104.9903
      json = ForecastService.get_weather(lat, lon)
